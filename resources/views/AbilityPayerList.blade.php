@section('title', 'Ability Payer List')
@include('layout.Head')
...
<div class="dashboard-wrapper">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        <h2 class="pageheader-title">Ability Payer</h2>
                        <a class="btn btn-primary" href="{{url('AddAbilityPayer',0)}}">
                            Add New Ability Payer</a>
                    </div>
                </div>
            </div>
            <br>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ url('AddAbilityPayer', $user->id) }}"
                                                        class="btn btn-sm btn-warning" data-toggle="tooltip"
                                                        data-placement="top" title=""
                                                        data-original-title="Edit {{ $user->name }}"><i
                                                            class="fa fa-pen-to-square"></i></a>
                                                    <button data-url="{{ url('DeleteAbilityPayer', $user->id) }}"
    ...
    <script>
        $(document).ready(function() {
            logAction("Ability Payer List Page Loaded");
        });
    </script>
