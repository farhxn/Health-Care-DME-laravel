...
<div class="dashboard-wrapper">
        ...
        <div class="container-fluid dashboard-content">
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title ml-auto">Add Sub Department</h2>
            ...
            <div class="ecommerce-widget">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <form method="post" action="{{ url('RegisterSubDepart') }}">
                            @csrf
                            <div class="card">
                                <h5 class="card-header">Add Sub Department Details</h5>
                                <div class="card-body">
    ...
    <script>
        $(document).ready(function() {
            logAction("Add Sub Department Page Loaded");
        });
    </script>
