@section('title', 'Form POS Type List')
@include('layout.Head')
...
<div class="dashboard-wrapper">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        <h2 class="pageheader-title">Form POS Type</h2>
                        <a class="btn btn-primary" href="{{url('AddFormPOSType',0)}}">
                            Add New Form POS Type</a>
                    </div>
                </div>
            </div>
            <br>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ url('AddFormPOSType', $user->id) }}"
                                                        class="btn btn-sm btn-warning" data-toggle="tooltip"
                                                        data-placement="top" title=""
                                                        data-original-title="Edit {{ $user->Code }}"><i
                                                            class="fa fa-pen-to-square"></i></a>
                                                    <button data-url="{{ url('DeleteFormPOSType', $user->id) }}"
    ...
    <script>
        $(document).ready(function() {
            logAction("Form POS Type List Page Loaded");
        });
    </script>
