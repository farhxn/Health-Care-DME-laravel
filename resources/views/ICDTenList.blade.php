...
<div class="dashboard-wrapper">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        <h2 class="pageheader-title">ICD 10</h2>
                        <a class="btn btn-primary" href="{{url('AddICDTen',0)}}">
                            Add New ICD 10</a>
                    </div>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            logAction("ICD 10 List Page Loaded");
        });
    </script>
