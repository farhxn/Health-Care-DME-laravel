...
<div class="dashboard-wrapper">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a class="btn btn-primary" href="{{ url('AddLocation',0) }}">
                            Add New Location</a>
                    </div>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            logAction("Location List Page Loaded");
        });
    </script>
