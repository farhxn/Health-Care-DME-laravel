@section('title', $dptName->Department.' Patient List')
@include('layout.Head')
@php
...
<input type="text" value="{{$dptName->id}}" class="statusID"/>
...
<div class="dashboard-wrapper">
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title ml-auto">{{ $dptName->Department }}</h2>
                            ...
                            <div class="container card-header">
                                <div class="row">
                                    <div class="col p-2">
                                        ...
                                        $statusIds = $apt->pluck('Order_Status')->unique();
                                    ...
                                    <div class="col p-2">
                                        <a href="{{ url('followUpPatient',$dptName->id) }}" class="btn btn-block btn-sm p-2" style="background-color: #427ed1; color: white;">FollowUp&nbsp;<span class="badge badge-light">( {{ $flpcount }} )</span> </a>
                                    </div>
                                    &nbsp;
                                    @if($userR =="2")
                                    <div class="col p-2">
                            ...
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="table display" id="myTable">
                                        ...
                                        <tbody>
                                            @include('partials.patients_partial', ['additionalPat' => $apt])
    ...
    <script>
        $(document).ready(function() {
            logAction("Department wise Patient List Page Loaded");

            var statusId = $('.statusID').first().val(); 
            ...
            $.ajax({
                url: '/PatientDepartmentList/' + statusId,
                type: 'GET',
                beforeSend: function() {},
