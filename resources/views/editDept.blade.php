...
<div class="dashboard-wrapper">
        ...
        <div class="container-fluid dashboard-content">
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title ml-auto">Edit Department</h2>
            ...
            <div class="ecommerce-widget">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <form method="post" action="{{ url('EditDepartmentDetail',$s?->id) }}">
                            @csrf
                            <div class="card">
                                <h5 class="card-header">Edit {{$s->Department}} Details</h5>
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3"><span class="input-group-prepend"><span
                                            ...
                                            <input type="text" required placeholder="Department" name="Department"
                                                class="form-control" value="{{ $s->Department }}">
                                        </div>
    ...
    <script>
        $(document).ready(function() {
            logAction("Edit Department Page Loaded");
        });
    </script>
