                ...
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex justify-content-between align-items-center m-3">
                            ...
                            <div class="ml-auto">
                                <?php if($mode != 'add'): ?>
                                <a href="#" class="btn btn-primary disabled">Created By: <?php echo e($order->CreatedBy); ?></a>
                                <a href="#" class="btn btn-primary disabled">Order # <?php echo e($order->id); ?></a>
                                <a href="#" class="btn btn-primary disabled">Order Date: <?php echo e($order->created_at->format('m/d/Y')); ?></a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="tab-content" id="myTabContent5">
                                ...
                                <div class="review-block">
                                    ...
                                    <ul class="list-unstyled arrow">
                                        ...
                                        <li>
                                            ...
                                            <br> <span><small class="text-dark font-weight-normal font-italic">
                                                    by <?php echo e($no->name); ?> at <?php echo e($no->created_at->format('m/d/Y h:i:s A')); ?> ON ORDER# <?php echo e($order->id); ?>
                            ...
                            <div class="tab-pane fade " id="tab-5" role="tabpanel" aria-labelledby="product-tab-4">
                                <form action="<?php echo e(url('AddDiagnosis')); ?>" method="post">
                                    ...
                                    <input type="hidden" name="OrderID" value="<?php echo e(old('OrderID',isset($order) ? $order->id : '')); ?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <select class="form-control form-control-sm" required id="Accident" name="Accident">
                                                            ...
                                                            <option value="Auto" <?php echo e(old('Accident', isset($diagnosis) ? $diagnosis->Accident : '') == 'Auto' ? 'selected' : ''); ?>>Auto</option>

                                                            <option value="No" <?php echo e(old('Accident', isset($diagnosis) ? $diagnosis->Accident : '') == 'No' ? 'selected' : ''); ?>>No</option>

                                                            <option value="Other" <?php echo e(old('Accident', isset($diagnosis) ? $diagnosis->Accident : '') == 'Other' ? 'selected' : ''); ?>>Other</option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input type="text" required placeholder="State Injury" name="StateInjury" id="StateInjury" class="form-control form-control-sm"
                                                            value="<?php echo e(old('StateInjury', isset($diagnosis) ? $diagnosis->StateInjury : '')); ?>">
                                                    </div>
                                                    <span>
                                                        <small class="text-danger font-weight-light font-italic">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <select class="form-control form-control-sm" id="ICD101" required name="ICD101">
                                                            ...
                                                            <option value="N/A" <?php echo e(old('ICD101', isset($diagnosis) ? $diagnosis->ICD101 : '') == 'N/A' ? 'selected' : ''); ?>>N/A</option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <select class="form-control form-control-sm" required id="ICD102" name="ICD102">
                                                            ...
                                                            <option value="N/A" <?php echo e(old('ICD102', isset($diagnosis) ? $diagnosis->ICD102 : '') == 'N/A' ? 'selected' : ''); ?>>N/A</option>
                                                            <?php $__currentLoopData = $icd10; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $drs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <select class="form-control form-control-sm" required id="ICD103" name="ICD103">
                                                            ...
                                                            <option value="N/A" <?php echo e(old('ICD103', isset($diagnosis) ? $diagnosis->ICD103 : '') == 'N/A' ? 'selected' : ''); ?>>N/A</option>
                                                            <?php $__currentLoopData = $icd10; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $drs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <select class="form-control form-control-sm" required id="ICD104" name="ICD104">
                                                            ...
                                                            <option value="N/A" <?php echo e(old('ICD104', isset($diagnosis) ? $diagnosis->ICD104 : '') == 'N/A' ? 'selected' : ''); ?>>N/A</option>
                                                            <?php $__currentLoopData = $icd10; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $drs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <select class="form-control form-control-sm" required name="ICD105" id="ICD105">
                                                            ...
                                                            <option value="N/A" <?php echo e(old('ICD105', isset($diagnosis) ? $diagnosis->ICD105 : '') == 'N/A' ? 'selected' : ''); ?>>N/A</option>
                                                            <?php $__currentLoopData = $icd10; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $drs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <select class="form-control form-control-sm" required name="ICD106" id="ICD106">
                                                            ...
                                                            <option value="N/A" <?php echo e(old('ICD106', isset($diagnosis) ? $diagnosis->ICD106 : '') == 'N/A' ? 'selected' : ''); ?>>N/A</option>
                                                            <?php $__currentLoopData = $icd10; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $drs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <select class="form-control form-control-sm" required name="ICD107" id="ICD107">
                                                            ...
                                                            <option value="N/A" <?php echo e(old('ICD107', isset($diagnosis) ? $diagnosis->ICD107 : '') == 'N/A' ? 'selected' : ''); ?>>N/A</option>
                                                            <?php $__currentLoopData = $icd10; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $drs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <select class="form-control form-control-sm" required name="ICD108" id="ICD108">
                                                            ...
                                                            <option value="N/A" <?php echo e(old('ICD108', isset($diagnosis) ? $diagnosis->ICD108 : '') == 'N/A' ? 'selected' : ''); ?>>N/A</option>
                                                            <?php $__currentLoopData = $icd10; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $drs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <select class="form-control form-control-sm" required name="ICD109" id="ICD109">
                                                            ...
                                                            <option value="N/A" <?php echo e(old('ICD109', isset($diagnosis) ? $diagnosis->ICD109 : '') == 'N/A' ? 'selected' : ''); ?>>N/A</option>
                                                            <?php $__currentLoopData = $icd10; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $drs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <select class="form-control form-control-sm" required name="ICD1010" id="ICD1010">
                                                            ...
                                                            <option value="N/A" <?php echo e(old('ICD1010', isset($diagnosis) ? $diagnosis->ICD1010 : '') == 'N/A' ? 'selected' : ''); ?>>N/A</option>
                                                            <?php $__currentLoopData = $icd10; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $drs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <select class="form-control form-control-sm" required name="ICD1011" id="ICD1011">
                                                            ...
                                                            <option value="N/A" <?php echo e(old('ICD1011', isset($diagnosis) ? $diagnosis->ICD1011 : '') == 'N/A' ? 'selected' : ''); ?>>N/A</option>
                                                            <?php $__currentLoopData = $icd10; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $drs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <select class="form-control form-control-sm" required name="ICD1012" id="ICD1012">
                                                            ...
                                                            <option value="N/A" <?php echo e(old('ICD1012', isset($diagnosis) ? $diagnosis->ICD1012 : '') == 'N/A' ? 'selected' : ''); ?>>N/A</option>
                                                            <?php $__currentLoopData = $icd10; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $drs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="tab-pane fade show active" id="tab-6" role="tabpanel" aria-labelledby="product-tab-4">
                                <?php if($mode != "view"): ?>
                                <form method="post" action="/AddEditOrders/<?php echo e($mode == 'edit' ? $order->id : 0); ?>">
                                    <?php endif; ?>
                                    <?php echo csrf_field(); ?>
                                    <div class="card">
                                        <br>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="hidden" id="patient-id" name="Patient_ID" value="<?php echo e(old('Patient_ID', $tp->id)); ?>">

                                                            <input type="text" required placeholder="Patient Name" name="Patient_Name" class="form-control form-control-sm" value="<?php echo e(old('Patient_Name', isset($order) ? $order->Patient_Name : $tp->name)); ?>">
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="text" required placeholder="Address" name="Address" class="form-control form-control-sm"
                                                                value="<?php echo e(old('Address', isset($order) ? $order->Address : $tp->Location)); ?>">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="text" required placeholder="City" id="City" name="City" class="form-control form-control-sm"
                                                                value="<?php echo e(old('City', isset($order) ? $order->City : '')); ?>">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="text" required placeholder="Account #" name="Account" class="form-control form-control-sm"
                                                                value="<?php echo e(old('Account', isset($order) ? $order->Account : $tp->AccNumber)); ?>">
                                                        </div>
                                                        <span><small class="text-danger font-weight-light font-italic">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="text" required placeholder="Phone" name="Phone" class="form-control form-control-sm"
                                                                value="<?php echo e(old('Phone', isset($order) ? $order->Phone : $phone1)); ?>">
                                                        </div>
                                                        <span><small class="text-danger font-weight-light font-italic">
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="text" required placeholder="Patient Last Name" name="Patient_Last_Name" class="form-control form-control-sm" value="<?php echo e(old('Patient_Last_Name', isset($order) ? $order->Patient_Last_Name : $tp->last_Name)); ?>">
                                                        </div>
                                                        <span><small class="text-danger font-weight-light font-italic">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="text" required id="State" placeholder="State" name="State" class="form-control form-control-sm"
                                                                value="<?php echo e(old('State', isset($order) ? $order->State : '')); ?>">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="text" required placeholder="ZIP" name="ZIP" id="ZIP" class="form-control form-control-sm"
                                                                value="<?php echo e(old('ZIP', isset($order) ? $order->ZIP : '')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="text" required placeholder="Patient DOB" name="Patient_DOB" class="form-control form-control-sm" value="<?php echo e(old('Patient_DOB', isset($order) ? $order->Patient_DOB : $tp->Dob)); ?>">
                                                        </div>
                                                        <span><small class="text-danger font-weight-light font-italic">
                                                                <?php $__errorArgs = ['Patient_DOB'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="text" required placeholder="Email" name="Email" class="form-control form-control-sm"
                                                                value="<?php echo e(old('Email',isset($order) ? $order->Email : $tp->p_mail)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col" style="border: 1px solid black; box-sizing: border-box; height: fit-content;">
                                                    <?php if($mode == "view"): ?>
                                                    <form action="<?php echo e(url('UpdateOrder', $mode == 'view' ? $order->id : 0)); ?>" method="post" id="updatePatientForm">
                                                        <?php echo csrf_field(); ?>
                                                        <?php endif; ?>
                                                        <input type="hidden" name="previous_url" value="<?php echo e(url()->previous()); ?>">
                                                        <input type="hidden" name="OrderID" value="<?php echo e(old('id',isset($order) ? $order->id : '')); ?>">
                                                        <span>&nbsp;</span>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                <select class="form-control form-control-sm" required id="statusSelect" name="OrderStatus">
                                                                    ...
                                                                    <option value="<?php echo e($drs->id); ?>" <?php echo e(old('OrderStatus', isset($order) ? $order->OrderStatus : '') == $drs->id ? 'selected' : ''); ?>><?php echo e($drs->Status); ?></option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </select>
                                                            </div>
                                                            <span>
                                                                <small class="text-danger font-weight-light font-italic">
                                                                    <?php $__errorArgs = ['OrderStatus'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                <select class="form-control form-control-sm" id="statusdept-dropdown" required name="Department">
                                                                    <option disabled <?php echo e(old('Department', isset($order) ? $order->Department : '') == '' ? 'selected' : ''); ?>>Department </option>
                                                                    <?php $__currentLoopData = $department; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $drs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($drs->id); ?>" <?php echo e(old('Department', isset($order) ? $order->Department : '') == $drs->id ? 'selected' : ''); ?>><?php echo e($drs->Department); ?></option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </select>
                                                            </div>
                                                            <span>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                <select class="form-control form-control-sm" id="user-dropdown" required name="AssignUser">
                                                                    <option disabled <?php echo e(old('AssignUser', isset($order) ? $order->AssignUser : '') == '' ? 'selected' : ''); ?>>Assign User</option>
                                                                    <?php $__currentLoopData = $user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $drs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($drs->id); ?>" <?php echo e(old('AssignUser', isset($order) ? $order->AssignUser : '') == $drs->id ? 'selected' : ''); ?>><?php echo e($drs->name); ?></option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </select>
                                                            </div>
                                                            <span>
                                                                <small class="text-danger font-weight-light font-italic">
                                                                    <?php $__errorArgs = ['AssignUser'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <input type="hidden" value="<?php echo e(isset($order) ? $order->OrderStatus : ''); ?>" id="StatusCheck">
                                                                ...
                                                                <div class="small-text">
                                                                    ...
                                                                    <div class="col">
                                                                        <label class="custom-control custom-checkbox">
                                                                            <input type="checkbox" class="custom-control-input" name="options[]" value="Rx" id="view-only-checkbox" <?php echo e(in_array("Rx", $selectedOptions) ? 'checked' : ''); ?>>
                                                                    ...
                                                                    <div class="col">
                                                                        <label class="custom-control custom-checkbox">
                                                                            <input type="checkbox" class="custom-control-input" name="options[]" value="Eligibility Check" <?php echo e(in_array("Eligibility Check", $selectedOptions) ? 'checked' : ''); ?>>
                                                                    ...
                                                                    <div class="col">
                                                                        <label class="custom-control custom-checkbox">
                                                                            <input type="checkbox" class="custom-control-input" name="options[]" value="Office Notes and Medical Records" <?php echo e(in_array("Office Notes and Medical Records", $selectedOptions) ? 'checked' : ''); ?>>
                                                                            <span class="custom-control-label small-text">Office&nbsp;Notes&nbsp;and&nbsp;Medical&nbsp;Records</span>
                                                                        </label>
                                                                    </div>
                                                                    <div class="col">
                                                                        <label class="custom-control custom-checkbox">
                                                                            <input type="checkbox" class="custom-control-input" name="options[]" id="sleep-study-checkbox" value="Sleep Study" <?php echo e(in_array("Sleep Study", $selectedOptions) ? 'checked' : ''); ?>>
                                                                    ...
                                                                    <div class="col">
                                                                        <label class="custom-control custom-checkbox">
                                                                            <input type="checkbox" class="custom-control-input" name="options[]" id="non-sleep-study-checkbox" value="Non Sleep Study" <?php echo e(in_array("Non Sleep Study", $selectedOptions) ? 'checked' : ''); ?>>
                                                                            <span class="custom-control-label small-text">Non&nbsp;Sleep&nbsp;Study</span>
                                                                        </label>
                                                                    </div>
                                                                    <div class="col">
                                                                        <label class="custom-control custom-checkbox">
                                                                            <input type="checkbox" class="custom-control-input" name="options[]" value="Dr's NPI Verification" <?php echo e(in_array("Dr's NPI Verification", $selectedOptions) ? 'checked' : ''); ?>>
                                                                    ...
                                                                    <div class="col">
                                                                        <label class="custom-control custom-checkbox">
                                                                            <input type="checkbox" class="custom-control-input" name="options[]" value="Dr's License Check" <?php echo e(in_array("Dr's License Check", $selectedOptions) ? 'checked' : ''); ?>>
                                                                    ...
                                                                    <div class="col">
                                                                        <label class="custom-control custom-checkbox">
                                                                            <input type="checkbox" class="custom-control-input" name="options[]" value="Pecos Check" <?php echo e(in_array("Pecos Check", $selectedOptions) ? 'checked' : ''); ?>>
                                                                    ...
                                                                    <div class="col">
                                                                        <label class="custom-control custom-checkbox">
                                                                            <input type="checkbox" class="custom-control-input" name="options[]" value="Same &amp; Similar Check" <?php echo e(in_array("Same & Similar Check", $selectedOptions) ? 'checked' : ''); ?>>
                                                                    ...
                                                                    <div class="col">
                                                                        <label class="custom-control custom-checkbox">
                                                                            <input type="checkbox" class="custom-control-input" id="AuthRequired" name="options[]" value="Auth Required" <?php echo e(in_array("Auth Required", $selectedOptions) ? 'checked' : ''); ?>>
                                                                    ...
                                                                    <div class="col">
                                                                        <label class="custom-control custom-checkbox">
                                                                            <input type="checkbox" class="custom-control-input" id="AuthNotRequired" name="options[]" value="Auth Not Required" <?php echo e(in_array("Auth Not Required", $selectedOptions) ? 'checked' : ''); ?>>
                                                        ...
                                                        <div id="resupplyDiv" style="display: none;">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    <input type="date" name="resupplyDate" id="resupplyDate" class="form-control" value="<?php echo e(old('resupplyDate',isset($order) ? $order->resupplyDate : '')); ?>" />
                                                                </div>
                                                                <span>
                                                                    <small class="text-danger font-weight-light font-italic">
                                                                        <?php $__errorArgs = ['resupplyDate'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    <input type="date" id="newResupplyDate" name="newResupplyDate" class="form-control" value="<?php echo e(old('newResupplyDate',isset($order) ? $order->newResupplyDate : '')); ?>">
                                                                </div>
                                                                <span>
                                                                    <small class="text-danger font-weight-light font-italic">
                                                                        <?php $__errorArgs = ['newResupplyDate'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    <select class="form-control" id="newFrequency" name="newFrequency">
                                                                        ...
                                                                        <option value="30" <?php echo e(old('newFrequency', isset($order) ? $order->newFrequency : '') == '30' ? 'selected' : ''); ?>>30 Days</option>

                                                                        <option value="60" <?php echo e(old('newFrequency', isset($order) ? $order->newFrequency : '') == '60' ? 'selected' : ''); ?>>60 Days</option>

                                                                        <option value="90" <?php echo e(old('newFrequency', isset($order) ? $order->newFrequency : '') == '90' ? 'selected' : ''); ?>>90 Days</option>

                                                                        <option value="180" <?php echo e(old('newFrequency', isset($order) ? $order->newFrequency : '') == '180' ? 'selected' : ''); ?>>180 Days</option>

                                                                        <option <?php echo e(old('newFrequency', isset($order) ? $order->newFrequency : '') == '365' ? 'selected' : ''); ?> value="365">365 Days</option>
                                                                    </select>
                                                                </div>
                                                                <span>
                                                                    <small class="text-danger font-weight-light font-italic">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    <select class="form-control " id="newDept" name="newDept">
                                                                        <?php $__currentLoopData = $department; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e($sts->id); ?>" <?php echo e(old('newDept', isset($order) ? $order->newDept : '') == $sts->id ? 'selected' : ''); ?>><?php echo e($sts->Department); ?></option>
                                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="text" required placeholder="Phone 2" name="Phone2" class="form-control form-control-sm" value="<?php echo e(old('Phone2',isset($order) ? $order->Phone2 : $phone2)); ?>">
                                                        </div>
                                                        <span><small class="text-danger font-weight-light font-italic">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="text" required placeholder="Dr Office" name="DrOffice" class="form-control form-control-sm" value="<?php echo e(old('DrOffice', isset($order) ? $order->DrOffice : $offName->Office_Name)); ?>">
                                                        </div>
                                                        <span><small class="text-danger font-weight-light font-italic">
                                                                <?php $__errorArgs = ['DrOffice'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="text" required placeholder="Dr Office Phone" name="DrPhone" class="form-control form-control-sm"
                                                                value="<?php echo e(old('DrPhone', isset($order) ? $order->DrPhone : '(' . substr($offName->Phone_Num, 0, 3) . ') ' . substr($offName->Phone_Num, 3, 3) . '-' . substr($offName->Phone_Num, 6))); ?>">

                                                        </div>
                                                        <span><small class="text-danger font-weight-light font-italic">
                                                                <?php $__errorArgs = ['DrPhone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="text" required placeholder="Dr Office Fax" name="DrFax" class="form-control form-control-sm"
                                                                value="<?php echo e(old('DrFax', isset($order) ? $order->DrFax :'(' . substr($offName->Fax, 0, 3) . ') ' . substr($offName->Fax, 3, 3) . '-' . substr($offName->Fax, 6))); ?>">

                                                        </div>
                                                        <span><small class="text-danger font-weight-light font-italic">
                                                                <?php $__errorArgs = ['DrFax'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <select class="form-control form-control-sm" id="NPIDoctorName" required name="DrName">
                                                                <option disabled <?php echo e(old('DrName', isset($order) ? $order->DrName : '') == '' ? 'selected' : ''); ?>>DrName </option>
                                                                <?php $__currentLoopData = $DoctorsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $drs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($drs->FirstName. ' '.$drs->LastName); ?>" <?php echo e(old('DrName', isset($order) ? $order->DrName : '') == $drs->FirstName. ' '.$drs->LastName ? 'selected' : ''); ?> data-phone="<?php echo e($drs->Phone); ?>" data-npi="<?php echo e($drs->NPI); ?>"><?php echo e($drs->FirstName. ' '.$drs->LastName); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                        </div>
                                                        <span><small class="text-danger font-weight-light font-italic">
                                                                <?php $__errorArgs = ['DrName'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="text" readonly id="NPIDoctorPhone" required placeholder="Dr Phone" name="DrPhone1" class="form-control form-control-sm"
                                                                value="<?php echo e(old('DrPhone1', isset($order) ? $order->DrPhone1 : '' )); ?>">
                                                        </div>
                                                        <span><small class="text-danger font-weight-light font-italic">
                                                                <?php $__errorArgs = ['DrPhone1'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="text" required placeholder="Dr NPI" id="npiNumber" name="DrNPI" class="form-control form-control-sm" value="<?php echo e(old('DrNPI', isset($order) ? $order->DrNPI : '')); ?>">
                                                            <!-- 1538206818 -->
                                                        </div>
                                                        <span><small class="text-danger font-weight-light font-italic">
                                                                <?php $__errorArgs = ['DrNPI'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="text" readonly name="LastCheckUser" id="LastCheckUser" class="form-control form-control-sm"
                                                                value="<?php echo e(old('LastCheckUser', isset($order) ? $order->LastCheckUser : '')); ?>">
                                                        </div>
                                                        <span><small class="text-danger font-weight-light font-italic">
                                                                <?php $__errorArgs = ['LastCheckUser'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="date" name="CheckedDate" id="LastCheck" readonly class="form-control form-control-sm"
                                                                value="<?php echo e(old('CheckedDate', isset($order) ? $order->CheckedDate : '')); ?>">

                                                        </div>
                                                        <span><small class="text-danger font-weight-light font-italic">
                                                                <?php $__errorArgs = ['CheckedDate'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <select class="form-control form-control-sm" id="Order-Type-dropdown" required name="OrderType">
                                                            <option disabled <?php echo e(old('OrderType', isset($order) ? $order->OrderType : '') == '' ? 'selected' : ''); ?>>Order Type</option>

                                                            <option value="Retail Sale" <?php echo e(old('OrderType', isset($order) ? $order->OrderType : '') == 'Retail Sale' ? 'selected' : ''); ?>>Retail Sale</option>

                                                            <option value="Retail Rental" <?php echo e(old('OrderType', isset($order) ? $order->OrderType : '') == 'Retail Rental' ? 'selected' : ''); ?>>Retail Rental</option>

                                                            <option value="Insurance" <?php echo e(old('OrderType', isset($order) ? $order->OrderType : '') == 'Insurance' ? 'selected' : ''); ?>>Insurance</option>

                                                            <option value="Insurance Rental" <?php echo e(old('OrderType', isset($order) ? $order->OrderType : '') == 'Insurance Rental' ? 'selected' : ''); ?>>Insurance Rental</option>
                                                        </select>
                                                    </div>
                                                    <span>
                                                        <small class="text-danger font-weight-light font-italic">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                <input type="text" placeholder="Policy 1 " id="Policy1" name="Policy1" class="form-control form-control-sm policy-input" value="<?php echo e(old('Policy1')); ?>">
                                                            </div>
                                                            <span><small class="text-danger font-weight-light font-italic">
                                                                    <?php $__errorArgs = ['Policy1'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                <input type="text" placeholder="Policy 2" name="Policy2" id="Policy2" class="form-control form-control-sm"
                                                                    value="<?php echo e(old('Policy2', isset($order) ? $order->Policy2 : '')); ?>">

                                                            </div>
                                                            <span><small class="text-danger font-weight-light font-italic">
                                                                    <?php $__errorArgs = ['Policy2'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                <input type="text" placeholder="Policy 3 " name="Policy3" id="Policy3" class="form-control form-control-sm" value="<?php echo e(old('Policy3', isset($order) ? $order->Policy3 : '')); ?>">
                                                            </div>
                                                            <span><small class="text-danger font-weight-light font-italic">
                                                                    <?php $__errorArgs = ['Policy3'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                <input type="text" placeholder="Policy 4" name="Policy4" id="Policy4" class="form-control form-control-sm"
                                                                    value="<?php echo e(old('Policy4', isset($order) ? $order->Policy4 : '')); ?>">

                                                            </div>
                                                            <span><small class="text-danger font-weight-light font-italic">
                                                                    <?php $__errorArgs = ['Policy4'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <input type="hidden" id="diagnosis-codes" name="diagnosis_codes" value="<?php echo e(old('diagnosis_codes')); ?>">
                                            <hr>
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <select class="form-control form-control-sm" id="item-dropdown" required name="InventoryItem">
                                                                ...
                                                                <?php $__currentLoopData = $inventory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $drs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($drs->id); ?>" data-diagnosis="<?php echo e($drs->DiagnoseCode); ?>"><?php echo e($drs->Item_Name); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                        </div>
                                                        <span>
                                                            <small class="text-danger font-weight-light font-italic">
                                                                <?php $__errorArgs = ['InventoryItem'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <select class="form-control form-control-sm select2" id="PriceCode-dropdown" required name="PriceCode">
                                                                ...
                                                                <?php $__currentLoopData = $priceCode; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $drs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($drs->id); ?>"><?php echo e($drs->Insurance); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                        </div>
                                                        <span>
                                                            <small class="text-danger font-weight-light font-italic">
                                                                <?php $__errorArgs = ['PriceCode'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <input type="hidden" id="unique-id" name="Items" value="<?php echo e(old('Items', isset($order) ? $order->Items : $code)); ?>">
                                            <div class="row">
                                                <div class="col">
                                                    <table class="table display">
                                                        ...
                                                        <tbody id="ItemList" class="modal-blur-content">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center"><?php echo e($item->item); ?></td>
                                                                <td class="text-center"><?php echo e($item->warehouse); ?></td>
                                                                <td class="text-center"><?php echo e($item->priceCode); ?></td>
                                                                ...
                                                                <td class="text-center">
                                                                    <button type="button" data-toggle="modal" data-target="#ViewOrder"
                                                                        ...
                                                                        data-original-title="View <?php echo e($item->item); ?>">
                                                                        <i class="fa fa-eye"></i>
                                                                    </button>

                                                                    <?php if($mode != "view"): ?>
                                                                    <button
                                                                        data-url="/deleteOrderItem/<?php echo e($item->id); ?>"
                                                                        data-id="<?php echo e($item->id); ?>"
                                                                        id="delete-item-<?php echo e($item->id); ?>"
                                                                        class="btn btn-danger "
                                                                        style="padding: 0.25rem 0.5rem; font-size: 0.875rem; line-height: 1.5; border-radius: 0.2rem;"
                                                                        data-toggle="tooltip" data-placement="top" title=""
                                                                        data-original-title="Delete <?php echo e($item->item); ?>">
                                                                        <i class="fa fa-trash"></i>
                                                                    </button>
                                                                    <?php endif; ?>
                                                                </td>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="date" required placeholder="Signature on File" name="SignatureFile" class="form-control form-control-sm" value="<?php echo e(old('SignatureFile', isset($order) ? $order->SignatureFile : date('Y-m-d'))); ?>">
                                                        </div>
                                                        <span><small class="text-danger font-weight-light font-italic">
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="text" required placeholder="Months Valid " name="MonthsValid" class="form-control form-control-sm" value="<?php echo e(old('MonthsValid',isset($order) ? $order->MonthsValid : '')); ?>">
                                                        </div>
                                                        <span><small class="text-danger font-weight-light font-italic">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <textarea style="display:none;" id="eligibilityDetails" name="eligibilityDetails" rows="20" cols="80"><?php echo e(old('eligibilityDetails')); ?></textarea>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input
                                                                ...
                                                                value="<?php echo e(old('InsuranceEligibility', isset($order) ? $order->InsuranceEligibility : '')); ?>">
                                                            &nbsp;
                                                            &nbsp;
                                                            &nbsp;
                                                        ...
                                                        <span>
                                                            <small class="text-danger font-weight-light font-italic">
                                                                <?php $__errorArgs = ['InsuranceEligibility'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <select class="form-control form-control-sm" required name="TaxRate">
                                                                <option disabled <?php echo e(old('TaxRate', isset($order) ? $order->TaxRate : '') == '' ? 'selected' : ''); ?>>Tax Rate</option>
                                                                ...
                                                                <option value="<?php echo e($drs->Name .' ' .$drs->TotalTax); ?>" <?php echo e(old('TaxRate', isset($order) ? $order->TaxRate : '') == $drs->Name .' ' .$drs->TotalTax ? 'selected' : ''); ?>><?php echo e($drs->Name .' ' .$drs->TotalTax); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                                                                <option value="Tax Exempt 0%" <?php echo e(old('TaxRate', isset($order) ? $order->TaxRate : '') == 'Tax Exempt 0%' ? 'selected' : ''); ?>>Tax Exempt 0%</option>
                                                            </select>
                                                        </div>
                                                        <span>
                                                            <small class="text-danger font-weight-light font-italic">
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="text" required placeholder="Out of Pocket" name="OutPocket" class="form-control form-control-sm" value="<?php echo e(old('OutPocket', isset($order) ? $order->OutPocket : '')); ?>">
                                                        </div>
                                                        <span><small class="text-danger font-weight-light font-italic">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <select class="form-control" required name="Basis">
                                                                ...
                                                                <option value="Bill" <?php echo e(old('Basis', isset($order) ? $order->Basis : '') == 'Bill' ? 'selected' : ''); ?>>Bill</option>

                                                                <option value="Allowed" <?php echo e(old('Basis', isset($order) ? $order->Basis : '') == 'Allowed' ? 'selected' : ''); ?>>Allowed</option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <select class="form-control" required name="InvoiceForm">
                                                                ...
                                                                <option value="<?php echo e($drs->name); ?>" <?php echo e(old('InvoiceForm', isset($order) ? $order->InvoiceForm : '') == $drs->name ? 'selected' : ''); ?>><?php echo e($drs->name); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                        </div>
                                                        <span>
                                                ...
                                                <div class="form-group col ">
                                                    ...
                                                    <div class="input-group">
                                                        <select class="form-control form-control form-control-sm" required name="POS">
                                                            <option value="Home" <?php echo e(old('POS', isset($order) ? $order->POS : '') == 'Home' ? 'selected' : ''); ?>>Home</option>

                                                            <option value="Custodial Care Facility" <?php echo e(old('POS', isset($order) ? $order->POS : '') == 'Custodial Care Facility' ? 'selected' : ''); ?>>Custodial Care Facility</option>

                                                            <option value="Federal Qualified Health Center" <?php echo e(old('POS', isset($order) ? $order->POS : '') == 'Federal Qualified Health Center' ? 'selected' : ''); ?>>Federal Qualified Health Center</option>

                                                            <option value="Homeless Shelter" <?php echo e(old('POS', isset($order) ? $order->POS : '') == 'Homeless Shelter' ? 'selected' : ''); ?>>Homeless Shelter</option>

                                                            <option value="Hospice" <?php echo e(old('POS', isset($order) ? $order->POS : '') == 'Hospice' ? 'selected' : ''); ?>>Hospice</option>

                                                            <option value="Military Treatment Center" <?php echo e(old('POS', isset($order) ? $order->POS : '') == 'Military Treatment Center' ? 'selected' : ''); ?>>Military Treatment Center</option>

                                                            <option value="Mobile Unit" <?php echo e(old('POS', isset($order) ? $order->POS : '') == 'Mobile Unit' ? 'selected' : ''); ?>>Mobile Unit</option>

                                                            <option value="Nursing Facility" <?php echo e(old('POS', isset($order) ? $order->POS : '') == 'Nursing Facility' ? 'selected' : ''); ?>>Nursing Facility</option>

                                                            <option value="Office" <?php echo e(old('POS', isset($order) ? $order->POS : '') == 'Office' ? 'selected' : ''); ?>>Office</option>

                                                            <option value="Other Place of Service" <?php echo e(old('POS', isset($order) ? $order->POS : '') == 'Other Place of Service' ? 'selected' : ''); ?>>Other Place of Service</option>

                                                            <option value="Prison or Correctional Facility" <?php echo e(old('POS', isset($order) ? $order->POS : '') == 'Prison or Correctional Facility' ? 'selected' : ''); ?>>Prison or Correctional Facility</option>

                                                            <option value="Skilled Nursing Facility" <?php echo e(old('POS', isset($order) ? $order->POS : '') == 'Skilled Nursing Facility' ? 'selected' : ''); ?>>Skilled Nursing Facility</option>

                                                            <option value="Urgent Care" <?php echo e(old('POS', isset($order) ? $order->POS : '') == 'Urgent Care' ? 'selected' : ''); ?>>Urgent Care</option>
                                                        </select>
                                                    </div>
                                                    <span>
                                                        <small class="text-danger font-weight-light font-italic">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="row">
                                                <?php if($mode != "view"): ?>
                                                <div class="col">
                                                    <button type="submit" class="btn btn-primary btn-block"><?php echo e($mode == "add" ? "Add" : "Edit"); ?> Order</button>
                                                </div>
                                                <?php elseif($mode == "view"): ?>
                                                <div class="col">
                                                    <a href="<?php echo e(url('orderPDF', $mode == 'view' ? $order->id : 0)); ?>" target="_blank" class="btn btn-primary btn-block">Print Order</a>
                                                </div>
                                                <?php if($order->OrderType == 'Retail Rental'): ?>
                                                <div class="col">
                                                    <a href="<?php echo e(url('rentalAgreementPDF', $mode == 'view' ? $order->id : 0)); ?>" target="_blank" class="btn btn-primary btn-block">Print Rental Agreement</a>
                                                </div>
                                                <?php endif; ?>
                                                <?php if($order->OrderStatus == '12'): ?>
                                                <div class="col">
                                                    <a href="<?php echo e(url('generateClaimForm', $mode == 'view' ? $tp->id : 0)); ?>" target="_blank" class="btn btn-primary btn-block">Generate Claim Form</a>
                                                </div>
                                                <?php endif; ?>
                                                <div class="col">
                                                    <a href="<?php echo e(url('pickupTicketPDF')); ?>" target="_blank" class="btn btn-primary btn-block">Print Pickup Ticket</a>
                                                </div>
                                                <div class="col">
                            ...
                            <div class="tab-pane fade " id="tab-7" role="tabpanel">
                                <div class="review-block">
                                    ...
                                    <ul class="list-unstyled arrow">
                                        <li>
                                        <?php echo isset($order) ? nl2br(e($order->eligibilityDetails)) : ''; ?>



                                            <br> <span><small class="text-dark font-weight-normal font-italic">
                                                    by <?php echo e(isset($order) ? $order->CreatedBy : ''); ?> at <?php echo e(isset($order) ? $order->created_at->format('m/d/Y h:i:s A') : ''); ?> ON ORDER# <?php echo e(isset($order) ? $order->id : ''); ?>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                <label class="col-form-label form-control-sm">Inventory Item </label>
                                <div class="input-group mb-3">
                                    <input type="text" required placeholder="Inventory Item" id="InvItem" name="InventoryItem" class="form-control form-control-sm requiredField" readonly value="<?php echo e(old('InventoryItem')); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="col">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" required placeholder="DX Pointer 10" id="DXPointer10" name="DXPointer10" class="form-control form-control-sm requiredField" value="<?php echo e(old('DXPointer10')); ?>">
                                </div>
                                <span><small class="text-danger font-weight-light font-italic">
                                        <?php $__errorArgs = ['DXPointer10'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                <label class="col-form-label form-control-sm">Price Code </label>
                                <div class="input-group mb-3">
                                    <input type="text" required placeholder="PriceCode" id="priceCode" name="PriceCode" class="form-control form-control-sm requiredField" readonly value="<?php echo e(old('PriceCode')); ?>">
                                </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" required placeholder="Billing Code" name="BillingCode" id="BillingCode" class="form-control form-control-sm requiredField" value="<?php echo e(old('BillingCode')); ?>">
                                </div>
                                <span><small class="text-danger font-weight-light font-italic">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <select class="form-control form-control-sm requiredField" required id="WarehouseName" name="Warehouse">
                                        <?php $__currentLoopData = $warehouse; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $drs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($drs->Warehouse_Name); ?>"><?php echo e($drs->Warehouse_Name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <span>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" required id="PriorAuthModal" name="PriorAuth" class="form-control form-control-sm requiredField" value="<?php echo e(old('PriorAuth')); ?>">
                                </div>
                                <span><small class="text-danger font-weight-light font-italic">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" required placeholder="Billable" name="Billable" id="Billable" class="form-control form-control-sm requiredField" value="<?php echo e(old('Billable')); ?>">
                                </div>
                                <span><small class="text-danger font-weight-light font-italic">
                                        <?php $__errorArgs = ['Billable'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="date" required placeholder="Prior Auth Exp" id="PriorAuthExp" name="PriorAuthExp" class="form-control form-control-sm requiredField" value="<?php echo e(old('PriorAuthExp')); ?>">
                                </div>
                                <span><small class="text-danger font-weight-light font-italic">
                                        <?php $__errorArgs = ['PriorAuthExp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <textarea rows="2" required name="HAO" id="HAO" class="form-control form-control-sm requiredField" value="<?php echo e(old('HAO')); ?>"></textarea>
                                </div>
                                <span><small class="text-danger font-weight-light font-italic">
                                        <?php $__errorArgs = ['HAO'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" required placeholder="Allowable" name="Allowable" id="Allowable" class="form-control requiredField form-control-sm" value="<?php echo e(old('Allowable')); ?>">
                                </div>
                                <span><small class="text-danger font-weight-light font-italic">
                                        <?php $__errorArgs = ['Allowable'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="date" required placeholder="RX Exp" name="RXExp" id="RXExp" class="form-control form-control-sm requiredField" value="<?php echo e(old('RXExp')); ?>">
                                </div>
                                <span><small class="text-danger font-weight-light font-italic">
                                        <?php $__errorArgs = ['RXExp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            ...
                            <div class="card" style="border: 1px solid black;">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="date" required placeholder="From" id="DOSFrom" name="DOSFrom" class="form-control form-control-sm requiredField" value="<?php echo e(old('From')); ?>">
                                        </div>
                                        <span><small class="text-danger font-weight-light font-italic">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="date" required placeholder="To" name="DOSTo" id="DOSTo" class="form-control form-control-sm requiredField" value="<?php echo e(old('To')); ?>">
                                        </div>
                                        <span><small class="text-danger font-weight-light font-italic">
                                                <?php $__errorArgs = ['To'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text" required placeholder="Billing Month" id="BillingMonth" name="BillingMonth" class="form-control form-control-sm requiredField" value="<?php echo e(old('BillingMonth')); ?>">
                                        </div>
                                        <span><small class="text-danger font-weight-light font-italic">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="<?php echo e(url('AddNote', $tp->id)); ?>" id="NoteForm">
                    ...
                    <input type="hidden" name="OrderID" value="<?php echo e($mode == 'add' ? 0 : $order->id); ?>" />
                ...
                <div id="userDetailsContent">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <label for="ptName" class="col-form-label form-control-sm small-label">Patient Name:</label>
                                <input type="text" value="<?php echo e($tp->name); ?>&nbsp;<?php echo e($tp->last_Name); ?>">
                                <input type="hidden" value="<?php echo e($tp->id); ?>" name="ptName">
                            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                ...
                <a href="<?php echo e(url('invoicePDF', $mode == 'view' ? $order->id : 0)); ?>" target="_blank" class="btn btn-primary mb-3">Patient</a>
                <a href="/AddBatch/<?php echo e($mode == 'view' ? $order->id : 0); ?>/<?php echo e($tp->id); ?>" class="btn btn-primary mb-3">Insurance</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function toggleFields() {
        ...
        if (selectedValue === 'Retail Rental' || selectedValue === 'Retail Sale') {
            ...
            $('#Policy1').val('<?php echo e(isset($PatInsurance[0]) ? $PatInsurance[0]->Company : null); ?>');
            $('#Policy2').val('<?php echo e(isset($PatInsurance[1]) ? $PatInsurance[1]->Company : null); ?>');
            $('#Policy3').val('<?php echo e(isset($PatInsurance[2]) ? $PatInsurance[2]->Company : null); ?>');
            $('#Policy4').val('<?php echo e(isset($PatInsurance[3]) ? $PatInsurance[3]->Company : null); ?>');
        }
    }
...
`)
    ...
    $(document).ready(function() {
        ...
        //Address Set
        var fullAddress = "<?php echo e($tp->Location); ?>";
    ...
    if (mode != 'view') {
        ...
        document.getElementById('AddItemButton').addEventListener('click', function(event) {
            ...
            var PatientDiagnose = JSON.parse('<?php echo json_encode($comparingDiagnose); ?>');
...
</script><?php /**PATH D:\purana xammp\htdocs\ecommerce-laravel\data-mangment2\resources\views/AddOrder.blade.php ENDPATH**/ ?>