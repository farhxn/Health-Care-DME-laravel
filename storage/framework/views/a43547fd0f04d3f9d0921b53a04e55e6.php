...
<body onload="noBack();" onpageshow="if (event.persisted) noBack();" onunload="">
    ...
    <div class="splash-container">
        <div class="card ">
            ...
            <div class="card-body">
                <form method="post" action="<?php echo e(url('VerifyOTP')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="form-group">
                        <input  class="form-control form-control-lg" id="E-Mail" type="number" name="otp" required min="5" placeholder="5 digit OTP Code"
                            autocomplete="off" >
                            <span><small class="text-danger font-weight-light font-italic"><?php $__errorArgs = ['otp'];
...
unset($__errorArgs, $__bag); ?></small></span>
            ...
            <div class="card-footer bg-white p-0">
                <div class="card-footer-item card-footer-item-bordered">
                    <a href="<?php echo e(url('AuthMail')); ?>" class="footer-link">Resend Code</a>
                </div>
            </div>
        </div>
    </div>
...
<?php if(Session::has('success')): ?>
  ...
  icon: "error"
              ...
              <?php endif; ?>
<?php /**PATH D:\purana xammp\htdocs\ecommerce-laravel\data-mangment2\resources\views/verifyOTP.blade.php ENDPATH**/ ?>